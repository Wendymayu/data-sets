...
![演讲者介绍](images/8b7bb1e57c97cdcf4a2cfd7f2756529c.jpeg)
...
![AIOps应用模块概览](images/af8e5e1e538a37cdef58431cdc53952a.png)
...
![异常检测算法分类](images/18579f35e8d7311a711d7e0db0bed509.png)
...
![不同形态的指标曲线](images/509ec51669d1cb210dbad0b3da79c8a5.png)
...
![节假日效应流量模式对比](images/c6ab311c86a0fa817d489d971f234ce2.png)
...
![检测算法分类与适用场景](images/29208a0c3d4630706fc5f9fffb641aae.png)
...
![融合多模型异常检测方案](images/9bd82822c378305e0283498985991ece.png)
...
![AIOps指标异常检测算法总结](images/c9940830b815da726268c9d0d3e71df7.png)

这是我们对一个传统 AIOps 基于这种指标的异常检测算法的一个比较大的 summary 时间关系，也比较常见。

![故障根因定位算法分类](images/b219b81664a3c1dcf740c944cb19a183.png)
...
![ARMS Insights自动根因定位](images/ca0247dae61df344b5923e04e5315d75.png)
...
![逐层下钻根因定位算法](images/02bceaa5e3087513b98759736fafc973.png)
...
![代码级与SQL级根因定位](images/1fcf5356bcf27db93382aed835b70649.png)
...
![利用大模型进行根因分析](images/fabcafc16f73b10212ad087bb9d19d3a.png)

我们也尝试了一些用大模型的方式来解决这个通用性的问题，尝试下来比较靠谱的思路，引用今年清华的数据库一篇论文，也做了非常多的优化，利用大模型做 RCA 其实思路都一样，就是先有一个运维手册。

![基于运维手册的RAG根因分析](images/b5bea8a0e484a02c21bccbf29c813fd3.png)
...
![大模型函数调用与MoE模型](images/128d8760129a880fefa02bc7ba40cfa7.png)
...
![自然语言转PromQL智能机器人](images/0fdb1a36844c91ba6beb1b69bc2bd1b2.png)
...
![RAG与SFT方案对比](images/3c53bc3c6d296bbc44287aa66e888c29.png)
...
![Chain-of-Thought提示词方法](images/6795f02e7c42c643889cf3d3ac804ec3.png)
...
![PromQL推理步骤示例](images/58ab829ffcf6ef2a7c933ed9b8dc67d2.png)
...
![自然语言转PromQL系统架构](images/fa868e9fbef80a78b9a6a5fe03ac014e.png)
...
![自然语言转PromQL覆盖场景总结](images/5d4583ecd2c97ac32984a2b1c1143b80.png)
...
![AIGC对可观测性的机遇与挑战](images/9485bfc237d3ee33d2095c54a27b4294.png)

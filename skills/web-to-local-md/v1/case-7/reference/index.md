...
![图1 用户视角下的Agent工作流程](images/practical-guide-to-building-agentic-ai-applications-for-aws-china-region1-1024x528.png)
...
![图2 开发者视角下的Agent工作流程](images/practical-guide-to-building-agentic-ai-applications-for-aws-china-region2-1024x542.png)
...
![图3 Agentic AI应用逻辑架构](images/practical-guide-to-building-agentic-ai-applications-for-aws-china-region3-1024x662.png)
...
![图4 基于 Strands Agents 和中国区构建 Agentic AI 应用架构](images/practical-guide-to-building-agentic-ai-applications-for-aws-china-region-new4-1024x652.png)
...
![图5 部署完成输出](images/practical-guide-to-building-agentic-ai-applications-for-aws-china-region5.png)
...
![图6 方案前端布局](images/practical-guide-to-building-agentic-ai-applications-for-aws-china-region-new6-1024x511.png)
...
![图7 基于 AOS 和 Lambda 构建自定义知识库 MCP Server](images/practical-guide-to-building-agentic-ai-applications-for-aws-china-region7-1024x576.png)
...
![图8 MCP Server配置完成](images/practical-guide-to-building-agentic-ai-applications-for-aws-china-region8-1024x608.png)
...
![图9 Agent课件制作任务执行过程](images/practical-guide-to-building-agentic-ai-applications-for-aws-china-region9-1024x513.png)

查看输出内容和右侧信息可以看到 Agent 思考、制定计划的过程和工具使用情况，如：

![图10 首先调用 mem0_memory 工具查找之前的历史记忆](images/practical-guide-to-building-agentic-ai-applications-for-aws-china-region-newnew10-1024x579.png)

![图11 调用 time 工具获取 Agent所处的时间](images/practical-guide-to-building-agentic-ai-applications-for-aws-china-region-newnew11-1024x560.png)

![图12 使用 web search 工具检索互联网上的信息](images/practical-guide-to-building-agentic-ai-applications-for-aws-china-region-newnew12-1024x575.png)

![图13 使用 Knowledge Base 中的 textSimilaritySearch 工具检索知识库中的相关知识](images/practical-guide-to-building-agentic-ai-applications-for-aws-china-region-newnew13-1024x528.png)

![图14 使用 upload-file 工具将生成的 html 课件上传到 S3，生成访问链接](images/practical-guide-to-building-agentic-ai-applications-for-aws-china-region-newnew14-1024x532.png)

点击输出结果中的“查看课程设计方案”链接，可以查看和下载托管在云端的课件内容：

![图15 课件结果呈现](images/practical-guide-to-building-agentic-ai-applications-for-aws-china-region10-1024x514.png)
...
![图16 Langfuse可观测性单次对话指标](images/practical-guide-to-building-agentic-ai-applications-for-aws-china-region-new11-1024x297.png)

点击一条追踪记录详情之后，能看到每一次模型和工具调用记录详细日志及关键指标。

![图17 Langfuse可观测性 Agent运行内部执行过程和细节](images/practical-guide-to-building-agentic-ai-applications-for-aws-china-region-new12-1024x748.png)

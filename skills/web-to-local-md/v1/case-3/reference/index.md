![用Agent评测思路管理AI Coding —— 31万行代码AI重构的实践](images/56358efa3a7ea82a98536ca1eba0990b879755.jpg)

# 用Agent评测思路管理AI Coding —— 31万行代码AI重构的实践

<small style="color:gray">2026-05-07</small>
...
## [三、重构时间线与执行路径](#三、重构时间线与执行路径)

![重构时间线与执行路径](images/1c5fff78273feaf4892b46ad3fb757956195300.png)

### [阶段一：定义问题，借助 AI 梳理技术债（2026 年2月启动）](#阶段一-定义问题-借助-ai-梳理技术债-2026-年2月启动)
...
![AI辅助技术债梳理流程](images/8e1adbedb5a4ba7538ee34cb450750e02585642.png)

### [阶段二：调研并制定 AI 友好的研发规范（2026年2月底完成）](#阶段二-调研并制定-ai-友好的研发规范-2026年2月底完成)

通过技术债梳理，我们解决了重构哪里的问题，那么接下来要解决的就是“代码应该怎么写”。在全员 90% 代码依赖 AI Coding 的现状下，核心要解决的问题是“**如何将一两个用好 AI 的人的经验，高质量泛化到全组**”。

#### [为什么规范的价值被放大了？](#为什么规范的价值被放大了)
...
#### [用评测 Agent 的方式，管理 AI Coding](#用评测-agent-的方式-管理-ai-coding)
...
#### [将规范转化为 AI 的执行约束](#将规范转化为-ai-的执行约束)
...
![AI友好工程约束体系](images/b881ed542ea63d06cd4f2a56686d24942443923.png)

![AI Rule与Skill约束示意](images/88b1f3ae86144c7deeb58d47a03ef6141550224.png)

### [阶段三：建立 SOP，“见缝插针”完成渐进式重构（2026年3月- 4月）](#阶段三-建立-sop-见缝插针-完成渐进式重构-2026年3月-4月)

#### [Action 1：100% 借助 AI 完成工程分层与解耦重构](#action-1-100-借助-ai-完成工程分层与解耦重构)
...
![工程分层架构重构示意](images/c432e3ba3641f401f84d442769382524379599.png)
...
![主R打样与SOP分发流程](images/fe509bdfeca90d7ad1ea923b9314577f501480.png)

#### [Action 2：零排期重构——借着业务需求“渐进式重构业务模型”](#action-2-零排期重构——借着业务需求-渐进式重构业务模型)
...
#### [Action 3：重构质量保证](#action-3-重构质量保证)
...
![Pre-PR与AI CR审查流程](images/267e78761c5a7625b56270667241a33e1589951.png)
...
![关键经验总结](images/4c6075274fadd0c075bf19dc928f82101466302.png)

### [行动指南：如果你的团队也想落地](#行动指南-如果你的团队也想落地)
